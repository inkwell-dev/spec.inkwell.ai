...
| Scope (this set) | Core writer + reader flow |
...
| [`02-article.md`](./02-article.md) | Article read view + premium-lock variant (`/articles/[slug]`) | Standard |
...
| [`05-writer-analytics.md`](./05-writer-analytics.md) | Writer Analytics dashboard (`/dashboard/analytics`) | Standard |
...
4. Use **Experimental mode** for the editor screens (03 & 04) — they're the most layout-dense.
   **Standard mode** is fine for feed / article / dashboard.
...
- This set covers the **core writer + reader flow**. Not yet generated (ask to add):
  - **Marketplace story** — Discover Writers, Writer Profile (Evaluation) with AI Portfolio
    Insights, license purchase modal, magazine Library + Wallet.
  - **Auth** — Login, Personal Sign Up, Magazine Sign Up.
...
- [`../1-product-overview.md`](../1-product-overview.md) — vision, account model
- [`../2-features.md`](../2-features.md) — editor, AI features, analytics
- [`../3-user-flows.md`](../3-user-flows.md) — user journeys
